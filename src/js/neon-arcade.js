...
const gameData = {
    ...
    'emberpath': {
        title: 'Emberpath',
        description: 'A Pilgrim\'s Progress-inspired top-down adventure with hand-prompted AI art (Midjourney + Flow). Mobile-first exploration broken up by story scenes — built for the family. WASD on desktop, virtual joystick on mobile.',
        url: 'https://jaxsbr.github.io/emberpath/',
        image: 'img/emberpath.png',
        deviceType: 'both'
    },
    'vylux': {
        title: 'Vylux',
        description: 'A Tron-inspired isometric real-time strategy on a deterministic sim — single-player PvE wave defense with a roguelike-run shape. Hold the grid against escalating raider waves; pick tech upgrades between waves; survive the run.',
        url: 'https://jaxsbr.github.io/vylux/',
        image: 'img/vylux.png',
        deviceType: 'desktop'
    },
    'robo-war': {
        title: 'Robo War',
        description: 'A top-down arena shooter — WASD to move, mouse to aim and fire. One of my early hand-coded experiments, still fun for a quick round.',
